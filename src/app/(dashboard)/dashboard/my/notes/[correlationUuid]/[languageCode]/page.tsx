...
async function MyNoteDetailPage({params}: Props) {
  ...
  const note = await fetchNoteTranslation("own", correlationUuid, languageCode);
...
export default withPermissions(MyNoteDetailPage, {
  requiredPermissions: ["self.notes.show", "self.notes.update"],
  operator: "AND",
});
